[
   ...
   Strategy                     -- KW["strategy"] KW["{"] _1 KW["}"],
   Strategy.1:iter-star         -- _1,
   StrategyRef                  -- KW["strategy;"],
   ...
   OrientRef                    -- _1,
   Goto                         -- KW["execute"] _1 KW[";"],
   GotoOrient                   -- KW["execute"] _1 _2 KW[";"],
   Orientation                  -- KW["orienting"] _1,
   ...
   PayloadRef                   -- _1 KW["."] _2,
   ModHolderPrimNumRef          -- KW["@"] KW["X"] KW["["] _1 KW["]"],
