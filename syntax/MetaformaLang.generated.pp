[
   ...
   Main                         -- KW["sequence"] _1 KW["{"] _2 _3 KW["}"],
   Main.2:iter-star             -- _1,
   Main.3:iter-star             -- _1,
   Strategy                     -- KW["sequence"] _1 KW["{"] _2 _3 KW["}"],
   Strategy.2:iter-star         -- _1,
   Strategy.3:iter-star         -- _1,
   ...
   FuncPrimRef                  -- _1,
   FuncActuationRef             -- _1,
   Instr                        -- KW["do"] KW["{"] _1 _2 _3 KW["}"] _4,
   Instr.1:iter-star            -- _1,
   Instr.2:iter-star            -- _1,
   Instr.3:iter-star            -- _1,
   Instr                        -- KW["do"] KW["{"] _1 _2 _3 KW["}"],
   Instr.1:iter-star            -- _1,
   Instr.2:iter-star            -- _1,
   Instr.3:iter-star            -- _1,
   Instr                        -- KW["do"] _1 KW["{"] _2 _3 _4 KW["}"],
   Instr.2:iter-star            -- _1,
   Instr.3:iter-star            -- _1,
