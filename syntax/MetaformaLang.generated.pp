[
   ...
   Debug.1:opt                  -- _1,
   Debug.2:opt                  -- _1,
   ShowPackets                  -- KW["show"] KW["["] _1 KW["]"] KW[";"],
   ...
   BorderLeft                   -- KW["left"],
   BorderRight                  -- KW["right"],
   BorderTop                    -- KW["top"],
   BorderBottom                 -- KW["bottom"],
   Meta                         -- KW["meta"],
   Module                       -- KW["module"],
   Region                       -- KW["region"],
   Config                       -- KW["config"],
   ...
   ByteArr.1:iter-star-sep      -- _1 KW[","],
   MetaFieldRef                 -- _1,
   Disconnect                   -- _1 KW["("] _2 KW[","] _3 KW[")"] KW[";"],
   Connect                      -- _1 KW["("] _2 KW[","] _3 KW[")"] KW[";"],
   Rotate                       -- _1 KW["("] _2 KW[","] _3 KW[")"] KW[";"],
   RotateCont                   -- _1 KW["("] _2 KW[","] _3 KW[")"] KW[";"],
   Stop                         -- _1 KW["("] _2 KW[")"] KW[";"],
   Break                        -- KW["break"] KW[";"],
