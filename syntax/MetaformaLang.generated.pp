[
   ...
   BorderDecl                  -- KW["borders"] KW["["] _1 KW["]"] KW[";"],
   ...
   FieldDeclList               -- _1 _2 KW[";"],
   FieldDeclList.2:iter-sep    -- _1 KW[","],
   FieldDecl                   -- _1 _2 KW[";"],
   PacketVarDecl               -- _1 _2,
   MetaPartDecl                -- KW["parts"] KW["["] _1 KW["]"] KW[";"],
   MetaPartDecl.1:iter-sep     -- _1 KW[","],
   MetaSize                    -- KW["parts"] _1 KW[";"],
   MetaPart                    -- _1,
   MetaPartNoneRef             -- _1,
   Ref                         -- _1,
   PayloadRef                  -- _1,
   ...
   Send                        -- KW["send"] _1 KW["("] _2 KW[")"] _3 KW[";"],
   Send.3:opt                  -- _1,
   NbsClause                   -- KW["to"] _1,
   ...
   TryRegion                   -- KW["try"] _1 _2 _3 KW["including"] _4 _5 KW[";"],
   TryRegion.3:opt             -- _1,
   TryRegion.4:iter-star-sep   -- _1 KW[","],
   TryRegion.5:opt             -- _1,
   RegionDisable               -- KW["disable"] _1 KW[";"],
   MetaDisable                 -- KW["disable"] _1 KW[";"],
   MetaEnable                  -- KW["enable"] _1 KW[";"],
   ...
   SequencePrimRef             -- _1,
   SequenceRef                 -- _1,
   ModuleBorderCheck           -- _1 KW["."] _2 KW["("] _3 KW[")"],
   BorderArg                   -- _1,
   BorderArg                   -- _1 KW["."] _2,
