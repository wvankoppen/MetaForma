[
   ...
   Event                        -- _1,
   Rate                         -- KW["rate"] _1,
   Meta                         -- KW["to"] KW["meta-module"],
   Conn                         -- KW["on"] KW["connector"],
   Meta                         -- KW["to"] KW["meta-modules"],
   Conn                         -- KW["on"] KW["connectors"],
   Send                         -- KW["send"] _1 KW["("] _2 KW[")"] _3 _4 _5 KW[";"],
   Send.5:opt                   -- _1,
   Unicast                      -- KW["unicast"] _1 KW["("] _2 KW[")"] _3 _4 _5 KW[";"],
   Unicast.5:opt                -- _1,
